...
export const prodChains: Omit<EndpointOption, 'teleport'>[] = [
  ...
  },
  {
    info: 'earthychain',
    providers: {
      EarthyChain: 'wss://rpc.earthy.tech'
    },
    text: 'Earthy',
    ui: {
      color: '#25E561',
